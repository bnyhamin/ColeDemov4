...
public class GameManager : MonoBehaviour
{
    ...
    IEnumerator actualizar_puntaje(System.Action<int> callback, int idcontenido)
    {
        ...
        WWW conneccion = new WWW("http://167.71.101.78/colegio3d/actualizar_puntaje.php?id_usuario=" + idUsuario + "&id_contenido=" + idcontenido );
        yield return (conneccion);
    ...
    IEnumerator actualizarcontenidos_actuales(string contenidosactualizar, int idcontenido)
    {
        ...
        WWW conneccion = new WWW("http://167.71.101.78/colegio3d/actualizar_contenidosactuales.php?id_usuario=" + idUsuario + "&id_contenido="+ idcontenido + "&contenidos_actuales=" + contenidosactualizar);
        yield return (conneccion);
        print("DEBUG1 conneccion.text:" + conneccion.text);
        if (conneccion.text == "401")
        {
        ...
        else
        {
            ...
            if (id_tipo_contenido == 2)
            {
                ...
                PrefabUtility.SaveAsPrefabAsset(cube, _path);*/
                ...
                //string _path = Application.dataPath + "/Sprites/Clases/Contenido/" + idcontenido + "/ejercicio.prefab";
                //GameObject prefabmaterial = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>(_path);
                
                //panelContenido.transform; //panelContenido.GetComponent<ScrollRect>().content;

                //GameObject prefabmaterial = (GameObject)AssetDatabase.LoadMainAssetAtPath(_path);


                //string _path = Application.dataPath + "/Sprites/Clases/Contenido/" + idcontenido + "/ejercicio.prefab";
                //material = (GameObject)AssetDatabase.LoadMainAssetAtPath(_path);
                // material.transform.SetParent(panelEjercicios.transform);
                //string _path = Application.dataPath + "/Sprites/Clases/Contenido/" + idcontenido + "/ejercicio.prefab";
                //GameObject ejercicio = (GameObject)AssetDatabase.LoadMainAssetAtPath(_path);
                //GameObject video = Instantiate(VideoClase);        
                //video.transform.parent = canvas.transform;
